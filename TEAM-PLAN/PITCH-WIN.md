...
2. Card asks keep or skip while you spend.  
3. Vault + year fill — euros compound.  
4. Punchline: pay every day, do less in April.  
5. Honesty: vision card tonight; habit twin `/pulse` / SalBot chat is Phase-2.  
6. Cursor: Pro co-author polish + Cloud Agent chrome on this branch — visible craft, not a fake live card API.
...
## Refuse on camera
Claiming a live issued Taxfix debit card, bank AIS, payments, dual films, SalBot UI as the upload.

## Upload
Start Drive upload ASAP (slow Wi‑Fi). Hard **21:00**. Present **21:10**.